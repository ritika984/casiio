...
const CW = {
  body:        '#1c1c28',   // dark body
  topBar:      '#e07020',   // orange header
  display:     '#c8d4a0',   // green LCD
  displayBorder:'#8a9a60',
  keyBg:       '#2a2a3c',   // default key
  keyBgLight:  '#3a3a50',   // lighter variant
  trigBlue:    '#1a5fb4',   // blue trig row
  shiftOrange: '#e07020',   // shift key
  alphaRed:    '#c0392b',   // alpha key
  modeBlue:    '#2060a0',   // mode key
  numKey:      '#3a3a52',   // number keys
  opBlue:      '#1a5fb4',   // ÷ × blue
  opGreen:     '#27ae60',   // + green
  opRed:       '#c0392b',   // − red
  equalsOrange:'#e07020',   // = orange
  delRed:      '#c0392b',
  acGreen:     '#27ae60',
  histGray:    '#4a4a62',
  bottomBar:   '#161620',
  bottomBtn:   '#2060a0',
  text:        '#ffffff',
  subText:     '#f4a020',   // orange shift labels
  alphaText:   '#70e070',   // green alpha labels
  border:      '#404058',
};
...
export default function CalculatorScreen() {
  ...
  const K = (
    ...
    const { flex=1, textSize=12, shiftLabel, alphaLabel, tall } = opts ?? {};
    return (
      <TouchableOpacity
        key={label}
        style={[
...
const styles = StyleSheet.create({
  ...
  body:        { backgroundColor: CW.body, padding:8, gap:3 },
  studentInfo: { color:'#888899', fontSize:10, textAlign:'right', marginBottom:2 },

  row: { flexDirection:'row', gap:3, marginBottom:1 },

  key: {
    flex:1,
    backgroundColor: CW.keyBg,
    borderRadius:4,
    paddingVertical:9,
    alignItems:'center',
  ...
  // Bottom bar
  bottomBar:    { flexDirection:'row', gap:6, marginTop:6 },
